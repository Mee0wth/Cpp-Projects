/*******************************************************************************
 ** teamOne.cpp
 ** This is the implementation file for the teamOne class and includes all the
...
*****************************************************************************/
void TeamOne::addCharacter(int charType, string name)
{
    if (isEmpty())
    {
...
** of the queue.
*****************************************************************************/
void TeamOne::addCharBack(cNode* winner)
{
    if (isEmpty())
    {
        head = winner;
